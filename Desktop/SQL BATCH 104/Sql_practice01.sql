...
--SORU:Ogrenciler tablosundaki id ve isim sutununu getriniz
...
maas sutununun data tipi int olsun. maas 5000 buyuk olsun(check kisitlamasi). NOT NULL kısıtlaması olsun.
*/
